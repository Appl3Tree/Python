...
# ---------------------------- MODE TOGGLE------------------------------- #
def toggle_mode():
    global MODE_BG, MODE_FONT, password_button, add_button
    if mode_state.get():
        MODE_BG = BLACK
        MODE_FONT = WHITE
        ...
        add_button.destroy()
        password_button = Button(text='Generate Password', width=12, bg=MODE_BG, fg=MODE_FONT,
...
window.config(padx=20, pady=20, bg=MODE_BG)
...
website_entry = Entry(width=35, bg=MODE_BG, fg=MODE_FONT, highlightthickness=0)
...
email_user_entry = Entry(width=35, bg=MODE_BG, fg=MODE_FONT, highlightthickness=0)
...
password_button = Button(text='Generate Password', width=12, bg='blue', fg='red', highlightbackground=green)
password_button.grid(column=2, row=3)
...
dark_mode_toggle = Radiobutton(text='Dark Mode', value=1, bg=MODE_BG, fg=MODE_FONT, variable=mode_state,
                               command=toggle_mode)
light_mode_toggle.grid(column=0, row=4, sticky=W)
dark_mode_toggle.grid(column=0, row=5, sticky=W)
