...
if choice.lower() == 'left':
    ...
    if choice.lower() == 'wait':
        choice = input('You arrive at the island unharmed. There is a house with three doors. One red, one yellow and one blue. Which color do you choose?\n\t')
        if choice.lower() == 'yellow':
            ...
            print('That wasn\'t one of the colored doors - you somehow died of dysentery.')
    else:
